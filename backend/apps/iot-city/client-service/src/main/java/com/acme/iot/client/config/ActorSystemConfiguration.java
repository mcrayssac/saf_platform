...
public class ActorSystemConfiguration {
    ...
    public InterPodMessaging interPodMessaging() {
        try {
            ...
            logger.info("InterPodMessaging initialized for client-service");
    ...
    public RemoteMessageTransport kafkaMessageTransport(InterPodMessaging messaging) {
        ...
        logger.info("KafkaMessageTransport created for client-service");
        return transport;
    }
    ...
    public ActorSystem actorSystem(HttpClientActorFactory actorFactory, 
        ...
        logger.info("KafkaActorMessageHandler started for client-service");
    ...
    public void shutdown() {
        logger.info("Shutting down client-service messaging...");
