...
public class ControlService {
    ...
    public AgentView spawn(AgentCreateRequest req) {
        ...
        // TODO: En production, envoyer une commande au Runtime via le broker
        // pour créer l'acteur. Pour l'instant, on simule la création.
    ...
    public void destroy(String id) {
        // TODO: En production, envoyer une commande au Runtime via le broker
        // pour arrêter l'acteur. Pour l'instant, on simule l'arrêt.
